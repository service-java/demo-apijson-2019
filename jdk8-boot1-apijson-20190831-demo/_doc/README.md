...
https://gitee.com/TommyLemon/StaticResources/tree/master/APIJSONServer
<br />
<br />

### 1.下载后解压APIJSON工程

[打开APIJSON的GitHub主页](https://gitee.com/TommyLemon/APIJSON) &gt; Clone or download &gt; [Download ZIP](https://gitee.com/TommyLemon/APIJSON/archive/master.zip) &gt; 解压到一个路径并记住这个路径。
...
### 5.测试接口<br />
直接使用 [APIJSON在线工具](http://apijson.org/auto) 或 下载主页提供的 [客户端App](https://gitee.com/TommyLemon/APIJSON)。
